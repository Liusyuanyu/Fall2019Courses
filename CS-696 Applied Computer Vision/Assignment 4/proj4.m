...
% image1 = imread('../data/Mount_Rushmore_1.jpg');
% image2 = imread('../data/Mount_Rushmore_2.jpg');

% image1 = imread('../data/PetcoPark_1.jpg');
% image2 = imread('../data/PetcoPark_2.jpg');
...
% [x1, y1] = get_interest_points_sample(image1, feature_width);
% [x2, y2] = get_interest_points_sample(image2, feature_width);
...
% [image1_features] = get_features_sample(image1, x1, y1, feature_width);
% [image2_features] = get_features_sample(image2, x2, y2, feature_width);
...
% [matches, confidences] = match_features_sample(image1_features, image2_features);
